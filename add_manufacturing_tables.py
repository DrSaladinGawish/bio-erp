...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "product_id",
            sa.BigInteger,
            sa.ForeignKey("mfg_product.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "bom_id",
            sa.BigInteger,
            sa.ForeignKey("mfg_bom.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "material_id",
            sa.BigInteger,
            sa.ForeignKey("mfg_product.id", ondelete="RESTRICT"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "qty_consumed", sa.Numeric(18, 4), nullable=False, server_default="0"
        ),
        sa.Column("uom", sa.String(10), nullable=False, server_default="pcs"),
        sa.Column("sort_order", sa.Integer, nullable=False, server_default="0"),
    ...
    op.add_column(
        "cells",  # Requires Clarification: confirm your Cell table name
        sa.Column("workcenter_department", sa.String(100), nullable=True),
    )
    op.add_column(
        "cells", sa.Column("cost_rate_hour", sa.Numeric(18, 4), nullable=True)
    )
