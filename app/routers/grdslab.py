...
SOIL_TYPES = [
    {
        "name": "Blended granular base",
        "k_pci": 300,
        "k_kPa_mm": 81.4,
        "description": "Crushed stone, well-graded",
    },
    {
        "name": "Cement-treated base",
        "k_pci": 500,
        "k_kPa_mm": 135.7,
        "description": "CTB, high stiffness",
    },
    {
        "name": "Lean concrete base",
        "k_pci": 600,
        "k_kPa_mm": 162.9,
        "description": "Economical subbase",
    },
    {
        "name": "Lime-stabilized subgrade",
        "k_pci": 150,
        "k_kPa_mm": 40.7,
        "description": "Treatment for expansive clays",
    },
    {
        "name": "Sand-gravel (dense)",
        "k_pci": 200,
        "k_kPa_mm": 54.3,
        "description": "Well-compacted granular fill",
    },
    {
        "name": "Silty sand",
        "k_pci": 100,
        "k_kPa_mm": 27.1,
        "description": "Common native soil",
    },
    {
        "name": "Clay (stiff)",
        "k_pci": 75,
        "k_kPa_mm": 20.4,
        "description": "Moderate bearing capacity",
    },
    {
        "name": "Clay (medium)",
        "k_pci": 50,
        "k_kPa_mm": 13.6,
        "description": "Needs stabilization for heavy loads",
    },
    {
        "name": "Clay (soft)",
        "k_pci": 25,
        "k_kPa_mm": 6.8,
        "description": "Poor bearing â€” thick slab required",
    },
    {
        "name": "Peat / organic",
        "k_pci": 10,
        "k_kPa_mm": 2.7,
        "description": "Very low â€” ground improvement needed",
    },
]
...
FORKLIFT_TABLE = [
    ...
    },
    {
        ...
        "load_kN": 13.3,
        "wheel_load_kN": 3.33,
        "contact_area_mm2": 20000,
        "axles": 2,
    },
    {
        "model": "JLG 660SJ (boom)",
        "capacity_kg": 227,
        "load_kN": 2.2,
        "wheel_load_kN": 0.56,
        "contact_area_mm2": 12000,
        "axles": 2,
    },
    {
        "model": "CAT DP15",
...
AASHTO_TRUCKS = [
    {
        "designation": "H-10",
        "gvw_kN": 44.5,
        "axle_load_front_kN": 8.9,
        "axle_load_rear_kN": 35.6,
    },
    {
        "designation": "H-15",
        "gvw_kN": 66.7,
        "axle_load_front_kN": 13.3,
        "axle_load_rear_kN": 53.4,
    },
    {
        "designation": "H-20",
        "gvw_kN": 89.0,
        "axle_load_front_kN": 17.8,
        "axle_load_rear_kN": 71.2,
    },
    {
        "designation": "H-25",
        "gvw_kN": 111.2,
        "axle_load_front_kN": 22.2,
        "axle_load_rear_kN": 89.0,
    },
    {
        "designation": "HS-15",
        "gvw_kN": 106.8,
    ...
    },
    {
        "designation": "HS-30",
        "gvw_kN": 213.5,
        "axle_load_front_kN": 26.7,
        "axle_load_rear_kN": 106.8,
    },
]
...
async def calculate(
    ...
    concrete_strength_MPa: float = Query(
        30, description="Concrete compressive strength in MPa"
    ),
    subgrade_modulus_kPa_mm: float = Query(
        0.054, description="Subgrade reaction modulus in kPa/mm"
    ),
    contact_width_mm: float = Query(
        200, description="Contact width (bearing area width) in mm"
    ),
